...
mod = Arima(ts(dat$Precipitação, frequency = 12, start=1966 ) , order = c(0,0,1), seasonal = c(2,1,0))
...
- O modelo automático ainda não está ok para todos os testes
- Na próxima aula, vamos propor alguns modelos e verificar quais deles fornece melhor previsão.
